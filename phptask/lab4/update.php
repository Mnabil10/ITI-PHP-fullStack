...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($name_err) && empty($email_err) && empty($gender_err)){
        ...
        $sql = "UPDATE user SET name=?, email=?, gender=?, action_status=? WHERE id=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssssi", $param_name, $param_email, $param_gender, $param_agree,$param_id);
